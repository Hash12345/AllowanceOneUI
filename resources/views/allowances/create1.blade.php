                ...
                <div class="block block-rounded">
                    ...
                    <form action="{{route('allowances.store')}}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control form-control-sm @error('start_date') is-invalid @enderror" type="date" id="start_date" name="start_date" value="{{ old('start_date')}}" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control form-control-sm @error('return_date') is-invalid @enderror" type="date" id="return_date" name="return_date" value="{{ old('return_date')}}" >
                        ...
                        <div class="block-content block-content-full text-right border-top">
                            ...
                            <button id="btn-save" type="submit" class="btn btn-primary"><i class="fa fa-print mr-1"></i>Save</button>
